# -*- encoding: utf-8 -*-
# stub: paper_trail 14.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<request_store>.freeze, ["~> 1.4"])
    s.add_dependency(%q<appraisal>.freeze, ["~> 2.4.1"])
    s.add_dependency(%q<byebug>.freeze, ["~> 11.1"])
    s.add_dependency(%q<ffaker>.freeze, ["~> 2.20"])
    ...
    s.add_dependency(%q<rspec-rails>.freeze, ["~> 5.0.2"])
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.22.2"])
    s.add_dependency(%q<rubocop-packaging>.freeze, ["~> 0.5.1"])
    s.add_dependency(%q<rubocop-performance>.freeze, ["~> 1.11.5"])
    s.add_dependency(%q<rubocop-rails>.freeze, ["~> 2.12.4"])
    s.add_dependency(%q<rubocop-rake>.freeze, ["~> 0.6.0"])
    s.add_dependency(%q<rubocop-rspec>.freeze, ["~> 2.5.0"])
    s.add_dependency(%q<simplecov>.freeze, ["~> 0.21.2"])
    s.add_dependency(%q<mysql2>.freeze, ["~> 0.5.3"])
